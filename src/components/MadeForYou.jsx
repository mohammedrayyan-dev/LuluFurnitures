...
const MadeForYou = () => {
  return (
    <>
    <div className="bg-white flex flex-col max-w-7xl mx-auto lg:mb-[50px] justify-center items-center lg:items-start md:flex-row lg:flex-row md:gap-4 lg:gap-30 py-8 lg:py-0">
  ...
  <div className="hidden lg:block mb-10 w-full border-t border-[#33333366]" />
    ...
    <p className="text-[#6F6F6F] max-w-xs lg:max-w-2xl font-dm text-sm lg:text-lg">
